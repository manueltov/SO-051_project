...
void memory_create_buffers() {
	...
	// que deve ter capacidade para um vetor unidimensional
	// de inteiros com a dimensao [BUFFER_AGENDAMENTO]
	...
	// que deve ter capacidade para um vetor unidimensional
	// de inteiros com a dimensao [BUFFER_PEDIDO]
...
int memory_request_r_read(int id, struct operation *operacao) {
	...
	// procurar pedido de operação para a empresa no buffer BPedido
...
void memory_response_s_read(int id, struct operation *operacao) {
	...
	// procurar agendamento para o cliente no buffer BAgendamento
